...
def main():
	...
	dfObj.to_csv(constants.OUTPUT_FOLDER+'all_verbs_filtered_no_below_10_no_above_95_percent_above.csv')
	...
	dts=gensim_utils.load_gensim_dictionary_model(constants.OUTPUT_FOLDER+'gensimdictionary_all_nouns')
	dts.filter_extremes(no_below=10, no_above=0.95)
	dfObj=gensim_utils.get_document_frequency_in_dictionary(dts,as_pandas_df=True)
	#df3 = dfObj[dfObj[1] > dfObj[1].median()]
