...
output_file_path=constants.OUTPUT_FOLDER+'testimonial_fragments_updated.json'
...
def create_fragments_collection(dictionary_from_csv):
	...
	for main_leaf in main_leaves:
		...
		prototypical_leaves=[element for element in dictionary_from_csv if ((element['main_leaf']==main_leaf) and (element['mid_leaf']=="nan"))]
		...
		#find the mid_leaves
		mid_leaves=set([element['mid_leaf'] for element in dictionary_from_csv if ((element['main_leaf']==main_leaf) and (element['mid_leaf']!="nan"))])
