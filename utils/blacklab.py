...
def search_blacklab(query,window=5,document_id=None,lemma=False, include_match = True,search_terms = None):
	'''
	...
	for i in range(0,total,20):
		...
		result=parse_response(result,include_match = include_match,lemma=lemma,search_terms = search_terms)
